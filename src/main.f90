program hola
  ...
  ! Argumentos pasados por consola
    real(8), parameter :: p_min
    real(8), parameter :: p_max
    real(8), parameter :: p_step
    integer(4), parameter :: Cant_ps
    ...
    call read(arg, *) p_max
    CALL getarg(3,arg)
    call read(arg, *) p_step
    CALL getarg(4,arg)
    call read(arg, *) Cant_ps
